      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="bg-red-50 px-6 py-4 border-b border-red-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-red-800">Purge All Data</h3>
        ...
        <div className="px-6 py-5">
          ...
          <ul className="space-y-2 text-sm text-[#78716C]">
            <li className="flex items-center gap-2">
              ...
              All recorded thoughts and emotions
            </li>
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
              All session history
            ...
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
              All viral moments and achievements
            </li>
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
              The feed file will be cleared
            </li>
          </ul>
        </div>

        {/* Footer */}
        <div className="px-6 py-4 bg-[#F5F0E8] flex justify-end gap-3">
          <button
            onClick={onClose}
            disabled={isPurging}
            className="px-4 py-2 rounded-lg text-sm font-semibold text-[#44403C] hover:bg-white/50 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 flex items-center gap-2 bg-[#78716C]/10 text-[#78716C] hover:bg-red-100 hover:text-red-600"
